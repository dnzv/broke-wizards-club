...
const Spell = props => (
    <div className="m-6 px-6 pt-4 pb-6 shadow border-solid border-t-4 border-purple-600 text-gray-900">
        ...
        <p className="text-xs italic mb-6">{ props.footnote }</p>
        <div className="flex flex-wrap mb-4">
            <p className="text-sm">Tags:</p>
            { props.tags.map(tag =>
                <div
                    style={ { fontSize: '0.58rem', borderColor: '#cbc6c3' } }
                    className="font-bold uppercase mx-1 px-2 py-1
